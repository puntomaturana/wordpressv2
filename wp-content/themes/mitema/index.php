		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="banner-caption">
					...
					<?php
					$args = array('post_type' => 'bigbanner');
					$bigbanner = new WP_Query($args);

					if($bigbanner->have_posts()) : 
						while($bigbanner->have_posts()) : 
							$bigbanner->the_post(); ?>

							<h2><?php the_title(); ?></h2>
							<?php the_content(); ?>
							<div class="blue-button">
								<a class="scrollTo" data-scrollTo="popular" href="#">Descubre más</a>
							</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="section-heading">
					...
					<h2>Visita nuestra región</h2>
				</div>
			</div> 
		</div> 
		<div class="owl-carousel owl-theme">
			<?php
			$args = array('post_type' => 'popular_places');
		...
		<div class="row">
			<div class="col-md-12">
				<div class="section-heading">
					...
					<h2>Destacados para esta semana</h2>
				</div>
			</div> 
		</div> 
		<div class="row">
			<?php
			$args = array('post_type' => 'featured_places', 'posts_per_page' => 3);
			$featuredplaces = new WP_Query($args);
			if($featuredplaces->have_posts()) : 
				while($featuredplaces->have_posts()) : 
					$featuredplaces->the_post();
			?>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="service-item">
					<div class="icon">
						<img src="<?php echo get_template_directory_uri() ?>/img/service_icon_1.png" alt="">
					</div>
			...
			<div class="col-md-4">
				<div class="service-item">
					<div class="icon">
						<img src="<?php echo get_template_directory_uri() ?>/img/service_icon_2.png" alt="">
					</div>
			...
			<div class="col-md-4">
				<div class="service-item">
					<div class="icon">
						<img src="<?php echo get_template_directory_uri() ?>/img/service_icon_3.png" alt="">
					</div>
...
<section id="video-container">
	...
	<video autoplay="" loop="" muted>
		<source src="<?php echo get_template_directory_uri() ?>/img/highway-loop.mp4" type="video/mp4" />
		</video>
	</section>
